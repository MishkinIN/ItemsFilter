...
namespace BolapanControl.ItemsFilter {
    ...
    public class FilterControl : ItemsControl {
        private static readonly Lazy<FilterControl> lz_Empty = new(() => new FilterControl());
        public static FilterControl Empty { get => lz_Empty.Value; }
        /// <summary>
        ...
        private static readonly bool isInDesignMode = (bool)System.ComponentModel.DependencyPropertyDescriptor.FromProperty(
                    ...
                    //try {
                        ...
                        // Ok, make new view using constructor ...FilterView(model).
                        {
                            if (viewType.IsGenericType) {
                                ...
                                view = Activator.CreateInstance(constructed, item) as UIElement;
                            }
                            else {
