...
**DataGrid.**
В заголовок стандартного контрола DataGrid добавляется кнопка быстрой фильтрации по содержимому колонки (примерно так, как это можно выполнять в Excel или в стандартном проводнике Windows в режиме таблицы):
